...
exports.serialize = (xnone, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === xnone.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
    ...
    if (msg.key.fromMe){
        msg.sender = xnone.user.id.split(':')[0]+'@s.whatsapp.net'
    }
